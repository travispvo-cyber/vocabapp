    ...
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-black px-4">
      <div className="w-full max-w-sm fade-in">
        ...
        <div className="text-center mb-10">
          <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-violet-500 flex items-center justify-center">
          ...
          <p className="mt-2 text-gray-500 dark:text-gray-400 text-lg">
            Learn data science concepts daily
          </p>
        </div>
        ...
        <div className={cn(styles.card, 'space-y-6 p-6')}>
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Save bookmarks and track your progress
            </p>
          </div>
          ...
          <Link
            to="/"
            className="block w-full text-center py-3 text-violet-600 dark:text-violet-400 font-semibold hover:bg-violet-50 dark:hover:bg-violet-500/10 rounded-xl transition-colors"
          >
            Continue as guest
          </Link>
        </div>

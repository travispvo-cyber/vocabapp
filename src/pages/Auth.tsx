    ...
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-950 px-4">
      <div className="w-full max-w-sm fade-in">
        ...
        <div className={cn(styles.card, 'space-y-6 p-6')}>
          ...
          <Link
            to="/"
            className="block w-full text-center py-3 text-blue-500 dark:text-blue-400 font-semibold hover:bg-blue-50 dark:hover:bg-blue-500/10 rounded-xl transition-colors"
          >
            Continue as guest
          </Link>
        </div>

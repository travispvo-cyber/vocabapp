  ...
  return (
    <div className="space-y-8 fade-in">
      ...
      <div className="space-y-3">
        ...
        <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl overflow-hidden divide-y divide-gray-200/50 dark:divide-gray-800/50">
          {CATEGORIES.map(cat => (
            <button
              key={cat.value}
              onClick={() => toggleCategory(cat.value)}
              className="flex items-center justify-between w-full p-4 hover:bg-gray-100/50 dark:hover:bg-gray-800/50 transition-colors"
            >
      ...
      <div className="space-y-3">
        ...
        <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl overflow-hidden">
          <button className="flex items-center justify-center w-full p-4 text-red-500 font-semibold hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors">
            Sign Out
          </button>
        </div>
      </div>
